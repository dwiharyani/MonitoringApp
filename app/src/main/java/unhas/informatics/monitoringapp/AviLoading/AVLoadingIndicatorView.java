package unhas.informatics.monitoringapp.AviLoading;
...
import unhas.informatics.monitoringapp.AviLoading.indicators.LineScaleIndicator;
...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (mIndicator == null) {
            setIndicator(String.valueOf(DEFAULT_INDICATOR));
        }
        a.recycle();
    }
